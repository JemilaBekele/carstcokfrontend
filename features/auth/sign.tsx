          ...
          <form onSubmit={handleSignIn} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                className="w-full py-3.5 pl-12 pr-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white rounded-xl focus:outline-none focus:border-[#e94560] focus:ring-4 focus:ring-[#e94560]/10 transition-all"
                disabled={loading}
              />
              </div>
            </div>
